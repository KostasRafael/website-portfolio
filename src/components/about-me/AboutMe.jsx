...
export default function AboutMe() {
  return (
    <div id="about-me-div" style={{ padding: "20px" }}>
      <h1>Hi! My name is Konstantinos Rafael Manousoudakis.</h1>
      <div class="content">
      ...
      <p>
        ...
        improve their lives. In this tech world, I once again proved my ability
        to learn fast and my adaptability to new settings and challenges. I
        thrived in using new technologies, and in applying my strong sense of
        logic and problem-solving skills to finding optimal solutions to
        real-life problems. <br /> <br /> This is a short synopsis of my journey
        so far, and the result of this journey is me, an extremely resilient
        person with a solid understanding of myself and the world around me. A
        student of life who will in any circumstance figure out a way to keep
        going and growing. But also, a full stack web developer who has found
        what he loves and is here to stay. I am aspiring to find a job in a
        company comprised of enthusiastic individuals, ansd within an
        environment that encourages me to give it all I have.
      </p>
    </div>
  );
}
